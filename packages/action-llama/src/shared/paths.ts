...
export const CREDENTIALS_DIR = process.env.AL_CREDENTIALS_DIR ?? resolve(AL_HOME_DIR, "credentials");
export const STATE_DIR = resolve(AL_HOME_DIR, "state");
export const ENVIRONMENTS_DIR = process.env.AL_ENVIRONMENTS_DIR ?? resolve(AL_HOME_DIR, "environments");
