...
Agent authors write shorthand in `SKILL.md` (e.g. `LOCK("github issue acme/app#42")`). The preamble teaches the agent the underlying shell commands.
...
### Lock shorthand in SKILL.md

In your `SKILL.md`, write the lock operations naturally:
