...
The `SKILL.md` file combines configuration (credentials, models, schedule, webhooks, params) in its YAML frontmatter with the agent's instructions in its markdown body.
