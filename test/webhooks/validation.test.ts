...
describe("validateHmacSignature", () => {
  ...
  it("returns _unsigned when no secrets configured", () => {
    expect(validateHmacSignature("body", "sig", undefined)).toBe("_unsigned");
    expect(validateHmacSignature("body", "sig", {})).toBe("_unsigned");
  });
