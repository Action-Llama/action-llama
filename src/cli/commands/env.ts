...
export async function prov(name: string | undefined): Promise<void> {
  ...
  const persistResult = (partial: Record<string, unknown>) => {
    ...
    const config: EnvironmentConfig = {
      server: {
        ...
        hetznerServerId: partial.hetznerServerId as number | undefined,
        hetznerLocation: partial.hetznerLocation as string | undefined,
  ...
  const config: EnvironmentConfig = {
    server: {
      ...
      hetznerServerId: result.hetznerServerId as number | undefined,
      hetznerLocation: result.hetznerLocation as string | undefined,
